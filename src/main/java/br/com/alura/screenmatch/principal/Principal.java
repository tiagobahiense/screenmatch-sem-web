...
public class Principal {
    ...
    private void topEpisodiosPorSeroe(){
        buscarSeriePorTitulo();
        if (serieBusca.isPresent()){
            serieBusca.get();
    ...
    private void buscarEpisodiosDepoisDeUmaData(){
        ...
        if (serieBusca.isPresent()) {
            ...
            List<Episodio> episodiosAno = repositorio.episodiosPorSerieEAno(serie, Integer.parseInt(anoLancamento));
